window.initGeetest = function (e) {
  ...
  "use strict";
  var n = s(3), o = n.isNumber, r = n.isFunction, a = s(0).PREFIX;
  ...
  i.prototype = {
    ...
    _eventList: {
      ...
      var t = this._ele;
      return new _(e)._each((function (e, s) {
        t.setAttribute(e, s)
      })), this
    }, _removeAttrs: function (e) {
      var t = this._ele;
      return new i(e)._map((function (e) {
        t.removeAttribute(e)
      })), this
      ...
      var e = this._ele, t = e.parentNode;
      return t && t.removeChild(e), this
    }, _toggleClass: function (e) {
      var t = this, s = t._ele;
      return -1 === new i(s.className ? s.className.split(" ") : [])._indexOf(a + e) ? t._addClass(e) : t._removeClass(e), t
    }, _addClass: function (e) {
      var t = this._ele, s = new i(t.className ? t.className.split(" ") : []);
      ...
      var t = this._ele, s = new i(t.className.split(" "));
      e = a + e;
      var n = s._indexOf(e);
      ...
      var s = this, n = s._ele, o = s._eventList[e], r = function (e) {
        t(new g(s, e))
      };
      return new i(o)._map((function (e) {
        if (document.addEventListener) n.addEventListener(e, r); else if (document.attachEvent) n.attachEvent("on" + e, r); else {
          var o = n["on" + e];
          n["on" + e] = function (e) {
      ...
      var t = this._getBoundingClientRect(), s = document.body, n = document.documentElement,
        o = window.pageYOffset || n.scrollTop || s.scrollTop, r = window.pageXOffset || n.scrollLeft || s.scrollLeft,
        a = n.clientTop || s.clientTop || 0, i = n.clientLeft || s.clientLeft || 0, _ = t.top + o - a,
        l = t.left + r - i;
      return {top: Math.round(_), left: Math.round(l), width: t.right - t.left, height: t.bottom - t.top}
    }, _text: function (e) {
      var t = this, s = t._ele;
      ...
      var t, s, n = this, o = n._ele, r = !((s = document.createElement("canvas")).getContext && s.getContext("2d"));
      if (e) {
        if (r) {
      ...
      var e, t, s;
      try {
        for (var n = this._ele, o = n; o.parentNode != document.body && n.offsetTop - o.parentNode.offsetTop < 160;) o = o.parentNode, "hidden" == (t = "overflow", s = void 0, (e = o).currentStyle ? s = e.currentStyle[t] : window.getComputedStyle && (s = window.getComputedStyle(e, null).getPropertyValue(t)), s) && (o.style.overflow = "visible")
      } catch (r) {
      }
      return this
  ...
  "use strict";
  var n = window.document, o = n.body || n.getElementsByTagName("body")[0],
    r = n.head || n.getElementsByTagName("head")[0], a = /Mobi/i.test(navigator.userAgent),
    i = /msie 6\.0/i.test(navigator.userAgent);
  e.exports = {
    MOBILE: a, head: r, getCSS3: function () {
  ...
  var o = window.document, r = window.Math, a = o.getElementsByTagName("head")[0];
  ...
  var l = function (e) {
    return "object" == typeof e && null !== e
  }, g = /Mobi/i.test(navigator.userAgent) ? 3 : 0, c = {}, d = {}, p = function (e, t, s, n) {
    t = function (e) {
    ...
    var o = function (e) {
      ...
      if (!e) return "";
      var t = "?";
      return new i(e)._each((function (e, s) {
        (function (e) {
          return "string" == typeof e
        }(s) || function (e) {
          return "number" == typeof e
    ...
    if (s.offline) n({type: "fullpage", offline: !0}); else {
      var o = "geetest_" + (parseInt(1e4 * r.random()) + (new Date).valueOf());
      window[o] = function (e) {
        "success" == e.status ? n(e.data) : e.status ? n({type: "fullpage", offline: !0}) : n(e), window[o] = undefined;
        try {
          delete window[o]
        } catch (t) {
        }
    ...
    e.https ? s.protocol = "https://" : e.protocol || (s.protocol = window.location.protocol + "//"), "050cffef4ae57b5d5e529fea9540b0d1" !== e.gt && "3bd38408ae4af923ed36e13819b14d42" !== e.gt || (s.apiserver = "yumchina.geetest.com/", s.api_server = "yumchina.geetest.com"), e.gt && (window.GeeGT = e.gt), e.challenge && (window.GeeChallenge = e.challenge), l(e.getType) && s._extend(e.getType), f([s.api_server || s.apiserver], s.typePath, s, (function (e) {
      ...
      if (e.offline) t(new n(s)); else {
        ...
        "init" === a ? (d[o] = "loading", c[o].push(r), u(s, !0, s.protocol, e.static_servers || e.domains, e[o] || e.path, null, (function (e) {
          if (e) d[o] = "fail", m("networkError", s); else {
            d[o] = "loaded";
  ...
  "use strict";
  var n = s(1)._assign, o = s(2).MOBILE, r = s(6), a = s(7), i = s(11), _ = s(0), l = _.READY, g = _.BACK,
    c = _.COMPUTE_2, d = _.RADAR_SUCCESS, p = _.RADAR_ERROR, u = _.RADAR_NEXT, f = _.RADAR_NEXT_READY,
    h = _.RADAR_NEXT_HIDE, m = _.NOT_COMPATIBLE, w = _.INIT, b = _.SUCCESS;
  ...
  x.prototype = {
    _init: function () {
      ...
      var s = this._ui, n = this._status, o = this._event, r = this._config, a = "bind" === r.product;
      if (!n._equal(t) && t !== m) if (n._equal(w) || (s && s._onChangeStatus(e, t), s && s._tip()), n._equal(w)) this._initP = this._init(), n._set(l), setTimeout((function () {
        o._emitEvent(w)
      }), 0); else if (n._equal(u)) s._next(this._nextType); else if (n._equal(f)) s._showNext(), a && r.pure && o._emitEvent(f); else if (n._equal(h)) s._hideNext(), o._emitEvent(CLOSE); else if (n._equal([d])) s._success(this._result), setTimeout((function () {
        a && (s._panelHide(), r.pure && setTimeout((function () {
          s._panelRemove()
        }), 300)), o._emitEvent(b)
      }), 400); else if (n._equal(c)) a && !r.pure && s._panelShowLoading(), s._compute(); else if (n._equal(g)) return
    }, _addEvent: function (e, t) {
      return this._event._addEvent(e, t), this
    }, _destroy: function () {
      this._ui && this._ui._destroy()
    }, _verify: function () {
      var e = this._ui, t = this._config, s = this._status;
  ...
  "use strict";
  var n = s(8), o = s(9).make_$, r = s(2), a = r.MOBILE, i = r.IE6, _ = r.getCSS3, l = s(10), g = l.compile,
    c = l.template, d = s(0).csstext_wind, p = s(1), u = p._Element, f = p._Array, h = s(2), m = h.body, w = h.head,
    b = s(0), x = b.READY, v = b.START_COMPUTE, y = b.START_DETECT, k = b.BACK, E = b.COMPUTE_2, C = b.COMPUTE_1,
    T = b.DETECT, A = b.WAIT_COMPUTE, z = b.RADAR_SUCCESS, S = b.RADAR_ERROR, R = b.RADAR_NEXT, O = b.RADAR_NEXT_READY,
    P = b.RADAR_NEXT_HIDE, F = b.NOT_COMPATIBLE, N = b.RESET;

  function D(e) {
    var t, s = this, r = e._config;
  ...
  D.prototype = {
    _WIDTH: 260, _MAX: 200, _MIN: 0, _INTERVAL: 54e4, _tip: function () {
      var e = this._lang, t = this._status, s = this.$;
      if (s) {
        var n = !1;
        if (t._equal([x, P]) ? n = "ready" : t._equal([C, E]) ? n = "fullpage" : t._equal([z]) ? n = "success" : t._equal([S]) ? n = "error" : t._equal([R]) ? n = "next" : t._equal([O]) ? n = "next_ready" : t._equal(F) && (n = "not_compatible"), n) {
          if (s(".radar_tip")._setAttrs({
            tabIndex: "0",
            "aria-label": e[n]
          })._setStyles({"outline-width": 0}), t._equal(z)) s(".success_radar_tip_content")._text(e[n]); else if (t._equal([S])) {
            var o = this._captcha._errObj;
            if (o && o.code) {
              var r = this._config, a = /(\d+)$/.exec(o.code);
              "bind" === r.product ? (s(".panel_error_title")._text(o.user_error || ""), a && s(".panel_error_code_text")._text(a[0] || "")) : (s(".radar_tip_content")._text(o.user_error || ""), a && s(".radar_error_code")._text(a[0] || ""))
            } else s(".radar_tip_content")._text(e[n])
          } else s(".radar_tip_content")._text(e[n]);
          this._errorTip && t._equal(S) && (s(".radar_tip_content")._text("error"), this._errorTip = !1)
        }
      }
    }, _init: function () {
      var e = this;
      e._scale = 1, e._energy = 0, e._zoom(), e._skinP = e._loadSkin();
      var t = e.$, s = e._config, n = e._lang, o = e._captcha, r = e._status;
      return "bind" === s.product ? s.logo || t(".panel_footer")._setStyles({display: "none"}) : a && s.logo || (s.logo ? (t(".logo")._setProps({
        target: "_blank",
        href: s.homepage
      }), t(".success_logo")._setProps({
        target: "_blank",
        href: s.homepage
      })) : (t(".logo")._hide(), t(".success_logo")._hide())), s.logo && a && "bind" !== s.product ? (t(".goto")._addClass(s.theme)._moveTo(new u(m)), t(".goto_content_tip")._text(n.goto_homepage), t(".goto_confirm")._text(n.goto_confirm)._setProps({href: s.homepage}), t(".goto_cancel")._text(n.goto_cancel), t(".goto")._hide()) : t(".goto")._hide(), "bind" === s.product && (t(".panel")._hide()._addClass(s.theme)._moveTo(new u(m)), s.offline && t(".panel")._addClass("fallback"), e._css3 || t(".panel")._addClass("ie"), t(".panel_loading_content")._text(n.loading_content), t(".panel_success_title")._text(n.success_title), t(".panel_error_title")._text(n.error_title), t(".panel_error_content")._text(n.error_content), t(".panel_footer_copyright")._text(n.copyright), t(".panel_ghost")._addEvent("click", (function () {
        r._equal([z, S]) ? (e._panelHide(), r._equal(S) && o._closePanel()) : r._equal(O) && r._set(P)
      }))), "bind" !== s.product && new f(["ar", "fa", "iw", "ur"])._indexOf(s.lang) > -1 && (t(".radar_tip")._addClass("reversal"), t(".success_radar_tip")._addClass("reversal_success")), t(".reset_tip_content")._text(n.reset), e
    }, _addEvent: function () {
      var e, t, s, n = this, o = n.$, r = n._status, i = n._captcha;
      n._logo_click = !1, a ? (new f([o(".logo"), o(".success_logo")])._map((function (e) {
        e._addEvent("click", (function () {
          n._logo_click = !0, o(".goto")._show(), setTimeout((function () {
            o(".goto")._opacity(1)
          }), 300)
        }))
      })), new f([o(".goto_cancel"), o(".goto_ghost")])._map((function (e) {
        e._addEvent("click", (function () {
          n._logo_click = !1, o(".goto")._opacity(0), setTimeout((function () {
            o(".goto")._hide()
          }), 300)
        }))
      ...
      return o(".holder")._addEvent("keydown", (function (e) {
        ...
        n._captcha._errObj && "error_21" === n._captcha._errObj.code ? n._refreshPage() : n._reset()._then((function () {
          r._set(E)
        }))
      })), n
    }, _rotate: function (e) {
      var t = this.$, s = t(".dot"), n = t(".sector"), o = e._getX(), r = e._getY(), a = s._getBoundingClientRect(),
        i = o - (a.left + 8), _ = a.top + 8 - r, l = 180 * Math.atan(i / _) / Math.PI;
      ...
      var e = this._status, t = this.$, s = e._get();
      if (!e._equal([z, S, k])) return this;
      e._set(N), this._captcha._resetValidate(), s === z && (this._clearForm(), t(".ghost_success")._hide(), this._css3 && setTimeout((function () {
      ...
      var s = this.$;
      if (e === z) if (s(".holder")._replaceClass(e, t || null), this._css3) s(".ghost_success")._addClass("success_animate"), s(".panel_success")._addClass("success_animate"), s(".success_btn")._setStyles({width: s(".holder")._width() + "px"}), setTimeout((function () {
        s(".success_btn")._setStyles({width: "100%"})
      }), 2e3); else {
        var n = this._config;
        "bind" === n.product && n.pure || (s(".panel_success")._show()._addClass("success_animate"), s(".ghost_success")._show()._addClass("success_animate"))
      ...
      var t = this.$;
      if (this._form = u.$(e), this._form) return t(".form")._moveTo(this._form), this
      ...
      var t = this, s = t._config;
      "bind" === s.product && (s.pure || (t._panelShowSuccess(), t._panelRemove())), t._setForm(e)
    }, _setForm: function (e) {
      var t = this.$;
      t(".challenge")._setAttrs({value: e.geetest_challenge}), t(".validate")._setAttrs({value: e.geetest_validate}), t(".seccode")._setAttrs({value: e.geetest_seccode})
    }, _clearForm: function () {
      var e = this.$;
      return e(".challenge")._removeAttrs(["value"]), e(".validate")._removeAttrs(["value"]), e(".seccode")._removeAttrs(["value"]), this
    }, _panelShow: function () {
      var e = this.$;
      e(".panel_loading")._hide(), e(".panel_success")._hide(), e(".panel_error")._hide(), e(".panel_footer")._hide(), e(".panel_next")._hide(), e(".panel")._show(), setTimeout((function () {
        e(".panel")._opacity(1)
      }), 10), i && e(".panel_box")._setStyles({marginLeft: "0", marginTop: "0"})
    }, _panelRemove: function () {
      var e = this.$;
      e(".panel_box")._removeClass("panelshowclick"), e(".panel_box")._removeClass("ie6panelshowclick"), e(".panel_box")._removeClass("panelshowslide"), e(".panel_box")._removeClass("panelshowbeeline"), e(".panel_box")._setStyles({
        width: "",
        height: ""
      })
    }, _panelHide: function () {
      var e = this.$;
      e(".panel")._opacity(0), setTimeout((function () {
        e(".panel")._hide()
      }), 300)
    }, _destroy: function () {
      var e = this._config, t = this.$;
      ...
      var e = this.$;
      this._config.area && this._panelBindLoading(), this._panelShowPanel(), e(".panel_loading")._show(), this._show_panel_footer()
    }, _panelBindLoading: function () {
      var e = this._config, t = this.$, s = u.$(e.area);
      if (!s) return throwError(getError("api_appendTo", this._captcha));
      var n = s._getCoords(), o = t(".panel");
      o && o._setStyles({
        position: "absolute",
        left: toRem(n.left),
        top: toRem(n.top),
      ...
      var e = this.$;
      this._config.logo ? e(".panel_footer")._show() : (e(".panel_box")._addClass("no_logo"), e(".panel_footer")._hide())
  ...
  e.exports = function (e) {
    ...
    return e && e.offline && new n(["zh-cn", "en", "zh-hk"])._indexOf(e.lang) > -1 ? o[e.lang] : o["zh-cn"]
  }
}, function (e, t, s) {
  "use strict";
  var n = s(0).PREFIX;
  ...
  "use strict";
  var n = s(1), o = n._Array, r = n._Element, a = n._Object, i = s(3), _ = i.isString, l = (i.isNumber, s(0).PREFIX);
  e.exports = {
    compile: function g(e, t, s) {
      var n = e.split("."), i = n[0] || "div", c = new o(n)._slice(1)._map((function (e) {
        return l + e
      }))._join(" "), d = new r(i);
      return s("." + n[1], d), "input" == i ? d._setAttrs({
        type: "hidden",
        name: c
      }) : d._setProps({className: c}), _(t) ? d._setAttrs({textContent: t}) : new a(t)._each((function (e, t) {
      ...
      ".btn": {
        ".radar_btn": {
          ...
          ".ie_radar": {},
          ".radar_tip": {"span.radar_tip_content": {}, "span.reset_tip_content": {}, "span.radar_error_code": {}},
          "a.logo": {},
        ...
        ".ghost_success": {
          ".success_btn": {
            ...
            ".success_radar_tip": {"span.success_radar_tip_content": {}, "span.success_radar_tip_timeinfo": {}},
            "a.success_logo": {},
